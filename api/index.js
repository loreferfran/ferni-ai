...
app.post('/api/generate-image', async function(req, res) {
  try {
    ...
    var coverInstructions = imageType === 'cover'
      ? ' Create a premium ebook cover background for this topic and target audience. IMPORTANT: Do NOT include any text, letters, words, typography, title, subtitle, logo, watermark, numbers, or symbols. This image will be used as the visual background of an ebook cover. The app will add the title, subtitle, and sales hook later. Leave clean negative space for text placement: main title area in the upper third of the cover, subtitle and hook area in the lower third of the cover. Keep the main subject fully visible and unobstructed in the middle area. Do not place faces, characters, products, animals, food, or important objects in the text areas. Use a professional premium style adapted to the niche, topic, and target audience. Create a clean, balanced, high-end digital product cover background with safe margins, no cropped elements, no elements touching the edges, and enough empty space for text overlay. Vertical portrait ebook cover composition, marketplace-ready, premium infoproduct style, high perceived value.'
