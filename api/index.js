...
app.post('/api/generate-image', async function(req, res) {
  try {
    ...
    var coverInstructions = imageType === 'cover'
      ? ' IMPORTANT SIZE AND LAYOUT INSTRUCTIONS: Create the cover in vertical format with exact dimensions of 1600 x 2560 pixels. Vertical portrait orientation, professional ebook cover layout, full composition visible from top to bottom, centered framing, safe margins, no cropped elements, balanced spacing, optimized for PDF ebook cover and Hotmart marketplace. The composition must be perfectly centered and optimized for a professional PDF ebook cover. Keep all important elements fully visible inside safe margins — do not crop the main subject, do not cut off text, do not place important elements too close to the edges, keep all visual elements fully visible. Leave enough empty space around the borders for a clean and balanced layout. Use a complete top-to-bottom composition with professional spacing and strong visual hierarchy. The title and subtitle must be fully readable and centered. Avoid excessive zoom or framing that cuts off important parts of the design. High resolution, polished composition, professional publishing quality, optimized for digital product sales and ebook marketplaces.'
      : ' IMPORTANT SIZE AND LAYOUT INSTRUCTIONS: Image size must be exactly 1400 x 900 pixels. Create a professional internal ebook image designed for the inside pages of a high-quality PDF guide. The image must be designed specifically for the inside pages of an ebook, not as a cover. Use a clean, professional, visually appealing style that matches the ebook topic. The composition must be centered, balanced, and easy to place inside a PDF page layout. Keep all important elements fully visible inside safe margins — do not crop the main subject, do not cut off objects, do not place important elements too close to the edges, avoid excessive zoom or close-up framing. Leave enough empty space around the borders to ensure the image fits naturally inside an ebook page. Do not include large titles, subtitles, logos, watermarks, or promotional text unless specifically requested. Use professional lighting, realistic details, polished composition, and premium editorial quality. Modern, clean, elegant, suitable for educational content, tutorials, guides, checklists, lessons, or informational sections. High resolution, professional publishing quality, no distorted elements, no cropped details, optimized for PDF ebook formatting and digital product presentation.';
