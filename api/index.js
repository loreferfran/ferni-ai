...
app.post('/api/generate-image', async function(req, res) {
  try {
    ...
    var noTextRule = ' CRITICAL RULE: Do NOT include any text, words, letters, numbers, titles, subtitles, captions, labels, phrases, sentences, or typography of any kind anywhere in the image. The image must be 100% text-free. No watermarks. No logos. No faces. Pure visual composition only.';
    var prompt = req.body.prompt + coverInstructions + noTextRule;
